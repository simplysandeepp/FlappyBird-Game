...
public class GamePanel extends JPanel implements KeyListener, MouseListener {
	...
	private void drawMenu (Graphics g) {
		...
		// Credits :p
		drawCentered("Created by TEAM DUCK", FlappyBird.WIDTH, FlappyBird.HEIGHT, 600, g);
		g.setFont(flappyMiniFont); // Change font
		//drawCentered("https://docs.google.com/forms/d/e/1FAIpQLSeDp9esj7HavM4lD-iU1caoW-lIs2ROq_NGRKWJdmR5O_Ygpw/viewform", FlappyBird.WIDTH, FlappyBird.HEIGHT, 630, g);
		...
		if (gameState == MENU) {
			...
			if (gameBird.isAlive()) {
				...
				if (isTouching(textures.get("rateButton").getRect())) {
					Helper.openURL("https://docs.google.com/forms/d/e/1FAIpQLSeDp9esj7HavM4lD-iU1caoW-lIs2ROq_NGRKWJdmR5O_Ygpw/viewform"); // Open website
				}
